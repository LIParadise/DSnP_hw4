...
set shortmess=aoO
badd +0 src/mem/memCmd.h
badd +0 src/mem/memCmd.cpp
badd +0 src/mem/memMgr.h
badd +0 src/main/main.cpp
badd +0 src/util/util.h
badd +0 src/util/rnGen.h
badd +0 src/util/myUsage.h
badd +0 src/util/util.cpp
argglobal
silent! argdel *
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 50 - ((27 * winheight(0) + 22) / 45)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
50
